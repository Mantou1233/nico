...
async function load(client, cm) {
    cm.register({
        ...
        handler: async (interaction) => {
            const type = interaction.customId.slice(5);
    ...
    cm.register({
        ...
        handler: async (interaction) => {
            if (interaction.member.roles instanceof
            ...
            msg.reply({
                ...
                components: [
                    new Discord.ActionRowBuilder().addComponents(new Discord.ButtonBuilder()
                        ...
                        .setStyle(Discord.ButtonStyle.Success), new Discord.ButtonBuilder()
                        .setLabel("Text buttons")
                        .setCustomId("abut/text")
                        .setStyle(Discord.ButtonStyle.Secondary), new Discord.ButtonBuilder()
